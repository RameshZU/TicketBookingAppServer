...
class BookingTickets extends HttpServlet{
   ...
   def processGetMethod(req:HttpServletRequest,res:HttpServletResponse){
   ...
   def processPostMethod(req:HttpServletRequest,res:HttpServletResponse){
      res.setContentType("application/json")
   ...
   def processDeleteMethod(req:HttpServletRequest,res:HttpServletResponse){
     res.setContentType("application/json")
